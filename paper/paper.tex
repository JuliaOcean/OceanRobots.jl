...
\caption{Location of ocean robots that were collecting data on {\it 2024/05/27} for three types of observations (blue, green, and red dots). Deployments of Argo profilers that were being planned at the time are also shown (purple dots). Data is from https://www.ocean-ops.org and queried via \pkg{OceanRobots.jl}.}
\label{fig:ocean-ops}
\end{figure}
