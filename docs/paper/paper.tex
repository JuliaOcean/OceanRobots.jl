...
\keywords{Julia, Ocean, Climate, Robot, Observation, Platform, Sensor, Drifter, Buoy, Profiler, Satellite, Modeling, Artificial Intelligence, Data Assimilation, Parameter Inference, Climatology, Geospatial, Statistics}
...
\begin{lstlisting}[
    ...
    caption={Simulate surface drifter pathways in the Gulf of Mexico (Fig.~\ref{fig:drifters_speed}) from flow fields $u,v$ and initial positions $x,y$. The repetition of `u` and `v` in `FlowFields` reflects that flow fields are treated as time invariant in this example.}
]
...
trajectories=groupby(record(I),:ID)
\end{lstlisting}
...
%MITgcm : \cite{marshall1997fvi,camp-etal:04,HHG05,Forget2015a,Forget2024b}
%OCCA / ECCO : \cite{Forget2007,Forget2010,Forget2015a,FFL15,FP15,Forget2024b}
%More : \cite{Forget2021,Wu2022,OceananigansJOSS,Makie,Innes2018,Pluto}
